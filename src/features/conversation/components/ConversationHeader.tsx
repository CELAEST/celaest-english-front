...
export const ConversationHeader: React.FC<ConversationHeaderProps> = ({
  ...
  return (
    <div className="absolute top-0 left-0 right-0 flex justify-end items-center p-3 sm:p-5 z-30 select-none pointer-events-none gap-2 sm:gap-3">
      ...
      >
        <span className="text-xs sm:text-sm font-normal text-white tracking-wide">End interview</span>
        <svg className="w-4 h-3 text-red-400 group-hover:rotate-12 transition-transform duration-300" viewBox="0 0 24 16" fill="currentColor">
