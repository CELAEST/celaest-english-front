...
:root {
  ...
  --gradient-glow-orb: radial-gradient(circle, rgba(136, 104, 248, 0.8) 0%, rgba(96, 56, 224, 0.3) 50%, rgba(4, 4, 10, 0) 75%);
  --gradient-glass-card: linear-gradient(180deg, rgba(255, 255, 255, 0.05) 0%, rgba(255, 255, 255, 0.01) 100%);
...
- **Reflective Accent Serif**: `Playfair Display`, `Newsreader`, `Georgia`, `serif` *(used for inspirational titles & reading quotes, e.g. "I've been thinking about our last conversation.")*
- **Monospace**: `JetBrains Mono`, `Fira Code`, `monospace` *(used for stats, phonetics `/'materz/`, timing)*
