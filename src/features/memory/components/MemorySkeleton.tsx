...
export const MemorySkeleton: React.FC = React.memo(() => {
  return (
    <div
      ...
      className="relative w-full h-[100dvh] max-h-[100dvh] bg-[#000001] text-white flex flex-col justify-between select-none overflow-hidden p-2.5 xs:p-3 sm:p-5 lg:px-8 pt-2 sm:pt-4 pb-20 sm:pb-26 lg:pb-5 animate-pulse"
    >
      {/* 1. Top Header: Title + Category Filter Tabs */}
      <header className="relative w-full max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0 z-10">
        <div className="flex items-center gap-3">
          <div className="w-32 sm:w-36 h-7 sm:h-8 rounded-lg bg-[#14141d]" />
          <div className="w-16 h-6 rounded-full bg-[#0e0e15]" />
        </div>

        {/* Filter Pills (Speaking · Reading · Writing) */}
        <div className="flex items-center p-1 rounded-full bg-[#14141d] gap-1.5">
          <div className="w-20 sm:w-24 h-7 rounded-full bg-[#1e1e2d]" />
          <div className="w-20 sm:w-24 h-7 rounded-full bg-[#0e0e15]" />
          <div className="w-20 sm:w-24 h-7 rounded-full bg-[#0e0e15]" />
        </div>
      </header>
      ...
      <main className="relative flex-1 min-h-0 w-full max-w-5xl mx-auto flex items-center justify-center my-auto py-2">
        ...
        <article className="relative w-full max-w-[340px] xs:max-w-[370px] sm:max-w-[480px] lg:max-w-[520px] h-[365px] xs:h-[395px] sm:h-[450px] lg:h-[470px] rounded-3xl bg-[#14141d] p-6 sm:p-7 flex flex-col justify-between z-10">
          {/* Card Top Row */}
      ...
      {/* 3. Bottom Controls: Pagination hint */}
      <footer className="w-full max-w-sm mx-auto flex items-center justify-center py-2 shrink-0">
        <div className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#14141d]">
          <div className="w-2 h-2 rounded-full bg-[#1e1e2d]" />
          <div className="w-6 h-2 rounded-full bg-[#1e1e2d]" />
          <div className="w-2 h-2 rounded-full bg-[#1e1e2d]" />
        </div>
      </footer>
    </div>
