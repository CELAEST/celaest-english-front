...
export const WorkspaceHeroSection: React.FC<WorkspaceHeroSectionProps> = ({
  ...
  return (
    <div className="flex flex-col space-y-3 sm:space-y-4 max-w-[360px] md:max-w-[400px] xl:max-w-[450px] select-none text-left items-start pt-1 font-['Plus_Jakarta_Sans',sans-serif] z-10 shrink-0">
      ...
      <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-[42px] font-light text-white leading-[1.12] tracking-[-0.03em]">
