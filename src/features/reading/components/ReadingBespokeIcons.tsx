...
export const ReadingSuccessIcon: React.FC<IconProps> = ({
  ...
  return (
    ...
    >
      ...
      <circle cx="28" cy="28" r="24" fill={`url(#${softBaseId})`} />
      {/* Crisp Precision Boundary */}
      <circle cx="28" cy="28" r="23" stroke={`url(#${borderGradId})`} strokeWidth="1.75" />
...
export const NextReadingArrowIcon: React.FC<IconProps> = ({
  ...
  <svg
    ...
    aria-hidden="true"
  >
    <line x1="7" y1="16" x2="24" y2="16" stroke="#FFFFFF" strokeWidth="2.5" strokeLinecap="round" />
    <polyline
 ...
 */
export const ChronometerIcon: React.FC<IconProps> = ({ className = "w-6 h-6 sm:w-7 sm:h-7" }) => (
  <svg
 ...
 */
export const ReturnArrowIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <svg
    className={`shrink-0 transform group-hover:-translate-x-1 transition-transform duration-200 ${className}`}
    viewBox="0 0 24 24"
    fill="none"
...
export const VocabloTranslateIcon: React.FC<IconProps> = ({
  ...
  <svg className={`shrink-0 ${className}`} viewBox="0 0 16 16" fill="none" aria-hidden="true">
    {/* Left/Main Bubble */}
    <path
...
export const MemoryBankSaveIcon: React.FC<IconProps> = ({
  ...
  <svg className={`shrink-0 ${className}`} viewBox="0 0 16 16" fill="none" aria-hidden="true">
    ...
    <path d="M12.5 5V11M9.5 8H15.5" stroke="#DDD6FE" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
export const NexusTopicRadarIcon: React.FC<IconProps> = ({
  ...
  return (
    <svg className={`shrink-0 ${className}`} viewBox="0 0 48 48" fill="none" aria-hidden="true">
      {/* Outer Ring — thin, clean */}
      <circle cx="24" cy="24" r="18" stroke="#C4B5FD" strokeWidth="1.5" strokeOpacity="0.5" />

      {/* Inner Ring — medium, solid */}
      <circle cx="24" cy="24" r="11" stroke="#C4B5FD" strokeWidth="1.5" />
