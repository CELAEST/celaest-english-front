    ...
    <AppModal
      ...
      icon={
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
          <path d="M12 2L17.5 8.5L12 22L6.5 8.5L12 2Z" stroke="url(#wrt_hdr_grad)" strokeWidth="1.75" fill="url(#wrt_hdr_fill)" fillOpacity="0.2" />
                ...
                <div className="lg:col-span-7 space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-[13px]">
                      ...
                      <div className="flex items-center gap-2.5">
                        <span className="text-[11px] text-[#8a8a9e]">{getTierLabel(submission.scoreClarity || 0)}</span>
                        <span className="font-semibold text-white tabular-nums">{Math.round(submission.scoreClarity || 0)}%</span>
                      </div>
                    </div>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between text-[13px]">
                      ...
                      <div className="flex items-center gap-2.5">
                        <span className="text-[11px] text-[#8a8a9e]">{getTierLabel(submission.scoreGrammar || 0)}</span>
                        <span className="font-semibold text-white tabular-nums">{Math.round(submission.scoreGrammar || 0)}%</span>
                      </div>
                    </div>
                    <div className="h-2 w-full bg-white/[0.06] rounded-full overflow-hidden p-[1px]">
                      <div
              ...
              <article className="relative rounded-2xl bg-[#090A14] border border-white/[0.08] p-6 shadow-xl transition-all duration-300">
                <div className="flex items-center justify-between gap-3 mb-3.5">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-[15px] font-semibold text-white tracking-tight">Mentor Feedback</h3>
                  </div>
            ...
            <section className="relative rounded-2xl bg-[#090A14] border border-white/[0.08] p-6 sm:p-7 shadow-xl">
              <div className="flex items-center justify-between gap-3 mb-5">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-[15px] font-semibold text-white tracking-tight">Performance Report</h3>
                </div>
                <span className="text-[10.5px] font-bold uppercase tracking-[0.08em] text-[#8a8a9e]">
                  FULL REVIEW
                </span>
                ...
                <div>
                  ...
                  <ul className="space-y-2.5">
                    {strengths.map((item, idx) => (
                      <li key={idx} className="flex items-start gap-2.5 text-[13px] leading-relaxed text-[#d4d4e0]">
            ...
            <article className="relative rounded-2xl bg-[#090A14] border border-white/[0.08] p-5 shadow-xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-all duration-300">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <h3 className="text-[14px] font-semibold text-white tracking-tight">Extracted Memory Cards</h3>
            ...
            <article className="relative rounded-2xl bg-[#090A14] border border-white/[0.08] p-6 sm:p-7 shadow-xl transition-all">
              ...
              <div className="flex items-center justify-between gap-3 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2.5">
                    <h3 className="text-[16px] font-semibold text-white tracking-tight">What you wrote</h3>
              ...
              <div className="mt-8">
                ...
                >
                  ...
                  >
                    ...
                    {currentError.betterWay && (
                      <div className="relative mt-4">
                        <p className="text-xs font-semibold text-[#d4d4e0] uppercase tracking-wider">Full sentence:</p>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <BookOpen
                        className="h-3.5 w-3.5 shrink-0 text-[#a27ff3]"
                        aria-hidden="true"
                      />
                      <span className="text-xs font-semibold text-[#f4f4f7]">
                        Grammar rule:
                      </span>
                    </div>
