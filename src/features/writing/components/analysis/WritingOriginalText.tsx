...
export const WritingOriginalText: React.FC<WritingOriginalTextProps> = ({
  ...
  return (
    <>
      ...
      <article className="relative rounded-2xl bg-[#090A14] border border-white/[0.08] p-4 sm:p-5 shadow-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3.5 sm:gap-4 transition-all duration-300">
        <div className="flex items-center gap-3 min-w-0">
          <span className="flex h-9 w-9 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-xl bg-[#141028] border border-[#251d48]">
            <BookOpen className="h-4 w-4 sm:h-[18px] sm:w-[18px] text-[#A27FF3]" />
          </span>
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h3 className="text-[13.5px] sm:text-[14px] font-semibold text-white tracking-tight">
            ...
            <p className="text-[11.5px] sm:text-[12px] text-[#8a8a9e] truncate">
        ...
        {onNavigateToMemory && (
          <button
            ...
            className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl border border-[#A27FF3]/30 bg-[#A27FF3]/10 px-4 py-2 text-[12px] sm:text-[12.5px] font-medium text-[#c4b5fd] transition-colors hover:bg-[#A27FF3]/20 hover:text-white cursor-pointer"
          >
            View Memory Cards
      ...
      <article className="relative rounded-2xl bg-[#090A14] border border-white/[0.08] p-4 sm:p-6 lg:p-7 shadow-xl transition-all">
        ...
        <div className="flex items-center justify-between gap-3 mb-4 sm:mb-6">
          <div className="flex items-center gap-2.5 sm:gap-3">
            <FileText className="h-4.5 w-4.5 sm:h-5 sm:w-5 text-[#A27FF3] shrink-0" />
        ...
        <div className="flex items-start gap-3 sm:gap-4 pl-1 sm:pl-5 pr-2 sm:pr-28 mb-4">
          <QuoteGlyph className="w-[20px] sm:w-[25px] h-[16px] sm:h-[20px] shrink-0 mt-0.5 text-[#674ee6]" />
          <p className="text-[13.5px] sm:text-[14.5px] leading-[1.7] text-[#d4d4e0] font-normal whitespace-pre-line">
            "{content}"
          </p>
        </div>
