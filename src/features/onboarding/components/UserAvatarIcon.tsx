 ...
 */
export const UserAvatarIcon: React.FC<{ className?: string | undefined }> = ({ className = '' }) => (
  <div
  ...
  >
    <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#E2D9FF" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
