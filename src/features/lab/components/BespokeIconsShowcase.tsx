...
const ICON_CATALOGUE: IconEntry[] = [
  // ── Workspace Dashboard Callouts (24px viewBox) ──
  {
    ...
    category: 'workspace',
    description: 'Clean, iconic brain glyph with cerebral hemispheres and anatomical gyri folds. Apple SF Symbols standard.',
  ...
  },
  {
    ...
    category: 'workspace',
    description: 'Architectural open volume with clean spine and editorial text markings for "Next Reading".',
  ...
  },
  {
    ...
    category: 'workspace',
    description: 'Studio condenser capsule with acoustic suspension cradle for "Upcoming Interview".',
  ...
  // ── Nexus Centerpiece Icons (Large, 48px viewBox, holographic) ──
  {
    ...
    category: 'nexus',
    description: 'Multi-tier orbital calibration radar with crosshair reticle. Used in Step 1 of reading generation to signal AI target acquisition.',
  ...
  },
  {
    ...
    category: 'nexus',
    description: 'Double-helix lattice with volumetric synapse nodes. Represents personalized linguistic DNA mapping in Step 2.',
  ...
  },
  {
    ...
    name: 'Lexicon Codex',
    category: 'nexus',
    description: 'Architectural open book with radiant spine and ascending photonic beams. Finalizes reading assembly in Step 3.',
  ...
  },
  {
    ...
    category: 'step',
    description: 'Architectural book and feather glyph for reading layout finalization. Step 3 timeline node.',
  ...
  },
  {
    ...
    category: 'step',
    description: 'Crisp geometric checkmark with thick rounded strokes. Replaces step icons after completion.',
  ...
  // ── Reading UI Feature Icons (Medium, 24–28px viewBox) ──
  {
    ...
    category: 'reading-ui',
    description: 'High-contrast stopwatch dial with sweep hand and cardinal ticks. Displays estimated reading time.',
  ...
  },
  {
    ...
    category: 'reading-ui',
    description: 'Open book spine with text line etchings. Shows total word count and vocabulary density.',
  ...
  },
  {
    ...
    category: 'reading-ui',
    description: 'Triple-bar proficiency chart with milestone beacon pin. Displays active CEFR target level.',
  ...
  },
  {
    ...
    category: 'reading-ui',
    description: 'Assessment document with text lines and validation dot. Triggers post-reading comprehension check.',
  ...
  // ── Word Lookup Modal Icons ──
  {
    ...
    category: 'modal',
    description: 'Overlapping speech bubbles representing bilingual bridge for translation overlay.',
  ...
  },
  {
    ...
    category: 'modal',
    description: 'Synaptic node with plus trigger badge. Saves vocabulary to the user memory SRS system.',
  ...
  return (
    <div className="flex flex-col space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-base font-semibold text-white tracking-wide">Complete Bespoke Icon Catalogue</h3>
        ...
        return (
          <div key={cat} className="flex flex-col space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-[#6b6c82] font-mono">
                ({icons.length} icons)
              </span>
            </div>
