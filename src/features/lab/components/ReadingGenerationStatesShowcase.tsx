...
export const ReadingGenerationStatesShowcase: React.FC<ReadingGenerationStatesShowcaseProps> = ({
  ...
  const ringOffset = ringCircumference - (currentStepData.percentage / 100) * ringCircumference;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-[#8a8a9e]">
            Inspect and compare the 3 sequential AI states when generating a new personalized
            reading.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center p-6 rounded-2xl bg-[#030208] border border-white/[0.04] min-h-[300px]">
          ...
          <div className="relative w-40 h-40 sm:w-44 sm:h-44 flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <div
                className="flex items-center justify-center transition-all duration-500 animate-[fadeIn_0.4s_ease-out_both]"
                key={activeStep}
              >
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="flex flex-col items-center space-y-2">
                <div
                  className="flex items-center justify-center rounded-xl bg-[#111126] border border-white/[0.06] p-3 transition-all overflow-hidden"
                  style={{
                    width: Math.max(displaySize * 0.6, 40) + 24,
                    height: Math.max(displaySize * 0.6, 40) + 24,
                  }}
                >
                  <div
                    style={{
                      width: Math.max(displaySize * 0.6, 14),
                      height: Math.max(displaySize * 0.6, 14),
                    }}
                    className="flex items-center justify-center"
                  >
                ...
                <div key={step.id} className="flex flex-col items-center text-center">
                  ...
                  >
                    {isCompleted ? (
                      ...
                      <step.StepIcon
                        className={`w-3.5 h-3.5 ${isActive ? "text-white" : "text-[#5e6078]"}`}
                      />
                    )}
                  </button>
                  <span
