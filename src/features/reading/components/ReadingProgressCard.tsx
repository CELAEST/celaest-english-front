  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-5 flex flex-col space-y-3.5 shrink-0">
        {/* Title */}
        <span className="text-[13px] font-semibold text-white tracking-tight">Reading progress</span>
        ...
        <div className="flex items-center space-x-5">
          ...
          <div className="flex flex-col space-y-2.5">
            <div className="flex flex-col">
              <span className="text-[10px] uppercase tracking-wider text-[#7e8096] font-medium">Est. finish</span>
              <span className="text-sm font-medium text-white/90 tabular-nums">
                {estimatedMinutesLeft} min
              </span>
            </div>
            <div className="flex flex-col">
              <span className="text-[10px] uppercase tracking-wider text-[#7e8096] font-medium">Words</span>
              <span className="text-sm font-medium text-white/90 tabular-nums">
